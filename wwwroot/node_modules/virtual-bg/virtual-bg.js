...
var vbs = document.querySelector('body #vbs');
...
if(!vbs){
    ...
    $('body > .maplink').remove();
    $('.customscript:not(.maplink)').eq(0).attr('src', "/node_modules/@mediapipe/selfie_segmentation/selfie_segmentation.js");
    $('.customscript:not(.maplink)').eq(0).attr('id', "vbs");
    $('.customscript:not(.maplink)').eq(0).attr('crossOrigin', "anonymous");
    $('.customscript:not(.maplink)').eq(0).addClass('maplink');
