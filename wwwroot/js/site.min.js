        ...
        `+`<div class="chat-pm-empty ">
            ...
            <ul><li id='lastchat'></li></ul>`+`
              ...
              <div class="progress">
                ...
                </li>`;else{var n=[],c=(n.push(e[l].body),"");0<=e[l].body.indexOf("^")&&(n=e[l].body.split("^"),c="");for(var r=0;r<n.length;r++){var d=n[r];0<n[r].indexOf(",;,")&&(d=n[r].split(",;,")[1],c=n[r].split(",;,")[0],n[r]=n[r].replace(",;,"," ")),i=(i+='<li class="'+(e[l].isReciver?"from-me":"from-other")+'" data-id="'+e[l].id+'" >')+(e[l].grpContactName?"<div class='name'>"+e[l].grpContactName+"</div>":""),c&&(i+='<div class="card" data-id="'+(replyid||"")+`" >
                      <div class="card-header " `+ForwardSenderId(c)+">"+c.split(",@,")[0]+"</div>"),IsImage(d)?i+='<label ><a href="#" data-url="/Home/GetFile?fileName='+d+'&fileType=up" class="img-tag"><div><img  class="fupload" src="/Home/GetFile?fileName='+d+'&fileType=up&th=true" /></div><div>'+SimpleFileName(d)+"</div></a></label>":IsAudio(d)?i+='<label><div><audio controls src="/Home/GetFile?fileName='+d+'&fileType=up" ></audio></div><div> '+SimpleFileName(d)+"</div></label>":IsVideo(d)?i+='<label><div><video controls  ><source src="/Home/GetFile?fileName='+d+'&fileType=up" ></video></div><div> '+SimpleFileName(d)+"</div></label>":IsPdfOrDoc(d)?i+='<label><a href="/Home/GetFile?fileName='+d+'&fileType=up" target="_blank" ><div><img class="docpdfimg" src="/Home/GetFile?fileName='+d.substring(0,d.lastIndexOf("."))+'.jpg&fileType=up&th=true" /></div><div>'+SimpleFileName(d)+"</div></a></label>":i+='<label><a href="/Home/GetFile?fileName='+d+'&fileType=up" target="_blank" ><div><img src="/img/file-icon.png" class="img-ico" /></div><div>'+SimpleFileName(d)+"</div></a></label>",c&&(i+="</div>"),i=(i+=(e[l].isReciver?'<span class="'+IsSeen(e[l])+'">✓</span>':"")+"</li>")+('<li class="'+(e[l].isReciver?"from-me":"from-other")+"\" ><div class='date'>"+getNiceDateTimeFormat(e[l].createdDate)+"</div></li>")}}lmore?($(".lmore").before(i),(1<$(".lmore").length?$($(".lmore")[1]):$(".lmore")).remove(),lmore=!1,$(".lmore").on("click",function(){lmore=!0;var e=$(".contact.active").data("id");$.post("/Home/GetContactMessage",{minId:minId,contactId:e},function(e){$(".loading").hide(),null==e||0==e.length?SetEmptyMessage():(SetResultOfMessage(e),$(".contact.active .text-bg-success").html("0"))})})):(i+="<li id='lastchat'></li></ul>",o=s="",o=($(".contact.active").hasClass("grp")?(s=30<(a=a||$(".contact.active .group-name").html()).length?a.substring(0,29)+"...":a,$(".contact.active .chat-bio")):(s=30<(a=a||$(".contact.active .name").html()).length?a.substring(0,29)+"...":a,$(".contact.active .company").text(),$(".contact.active .role"))).text(),a=`
		<div class="row">
			<div class="chat px-3">
