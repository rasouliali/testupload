        ...
        `+i+`
              ...
              <div class="progress">
                <div class="progress-bar" id="my-progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
                        ...
                        </div>`;$("#search-contents").append(t),$(".content").on("click",function(){var e=$(this).data("id");$(".loading").show(),window.location.href="/?showInChat="+e})}})):($(".new-search-mess").hide(),$(".def-mess").show())}function getDuraton(e){var e=Math.round(e),t="";return 60<e&&(t=Math.floor(e/60)<10?"0"+Math.floor(e/60):Math.floor(e/60)),t+=(t?":":"00:")+(Math.floor(e%60)<10?"0"+Math.floor(e%60):Math.floor(e%60))}function openAllContact(i){$.post("/Home/AllContact",{},function(e){for(var t="",a=0;a<e.length;a++){var s=e[a];t+='<div class="new-ch contact col-12'+(ul&&ul.find(e=>e.userId.toLowerCase()==s.id.toLowerCase())?" online":"")+(s.isGroup?" grp":"")+'" data-id="'+s.id+`">
                            <div class="row">
