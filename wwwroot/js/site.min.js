function showStatus(){$("#status-options").css("opacity","1");$("#status-options").css("visibility","visible")}function searchData(){var n=$("#search input").val();n?($(".new-search-mess").hide(),$(".new-search-mess").removeClass("new-search-mess").addClass("search-mess"),$(".new-search-mess").html(""),$.post("/Home/GetAccounts",{searchKey:n},function(n){var t,r,i;if($(".def-mess").hide(),n.length==0){i=`<li class="contact new-search-mess">
                    ...
                    </li>`;$("#contacts ul").append(i);$(".new-search-mess").on("click",function(){fromNewChat=!1;$(".new-search-mess").removeClass("active");$(this).addClass("active");var n=$(this).data("id"),t=$(this).data("id");$.post("/Home/GetContactMessage",{minId:"0",contactId:n},function(t){$(".loading").hide();t==null||t.length==0?SetEmptyMessage():SetResultOfMessage(t);wsconn.invoke("SeenMessege","all",n)})})}})):($(".new-search-mess").hide(),$(".def-mess").show())}function SetEmptyMessage(n){var i=`<div class="chat-pm-empty ">
            ...
            <ul><li id='lastchat'></li></ul>`;n=n?n:$(".contact.active .name").html();var t=n.length>30?n.substring(0,29)+"...":n,e=$(".contact.active .company").text(),r=$(".contact.active .role").text(),u=$(".contact.active img").attr("src"),o=`<button id="nameofcontact" type="button"  data-toggle="tooltip" data-placement="bottom" title="`+n+`">
                          `+t+`
                        </button>`,f=`
		<div class="row">
			<div class="chat px-3">
        ...
        `+i+`
              ...
              <div class="progress">
                ...
                </li>`;else for(e=[],e.push(n[r].body),s="",n[r].body.indexOf("^")>=0&&(e=n[r].body.split("^"),s=""),o=0;o<e.length;o++)u=e[o],e[o].indexOf(",;,")>0&&(u=e[o].split(",;,")[1],s=e[o].split(",;,")[0],e[o]=e[o].replace(",;,"," ")),f+=`<li class="`+(n[r].isReciver?"from-me":"from-other")+`" data-id="`+n[r].id+`" >`,s&&(f+=`<div class="card" data-id="`+(replyid?replyid:"")+`" >
                      <div class="card-header " `+ForwardSenderId(s)+`>`+s.split(",@,")[0]+`</div>`),f+=IsImage(u)?`<label><a href="#" data-url="/Home/GetFile?fileName=`+u+`&fileType=up" class="img-tag"><div><img  class="fupload" src="/Home/GetFile?fileName=`+u+`&fileType=up&th=true" /></div><div>`+u+`</div></a></label>`:IsAudio(u)?`<label><div><audio controls src="/Home/GetFile?fileName=`+u+`&fileType=up" ></audio></div><div> `+u+`</div></label>`:IsVideo(u)?`<label><div><video controls  ><source src="/Home/GetFile?fileName=`+u+`&fileType=up" ></video></div><div> `+u+`</div></label>`:IsPdfOrDoc(u)?`<label><a href="/Home/GetFile?fileName=`+u+`&fileType=up" target="_blank" ><div><img class="docpdfimg" src="/Home/GetFile?fileName=`+u.substring(0,u.lastIndexOf("."))+`.jpg&fileType=up&th=true" /></div><div>`+u+`</div></a></label>`:`<label><a href="/Home/GetFile?fileName=`+u+`&fileType=up" target="_blank" ><div><img src="/img/file-icon.png" class="img-ico" /></div><div>`+u+`</div></a></label>`,s&&(f+=`</div>`),f+=(n[r].isReciver?`<span class="`+IsSeen(n[r])+`">✓</span>`:"")+`</li>`,f+=`<li class="`+(n[r].isReciver?"from-me":"from-other")+`" >`+"<div class='date'>"+getNiceDateTimeFormat(n[r].createdDate)+"<\/div>"+`</li>`;if(lmore){$(".lmore").before(f);$(".lmore").length>1?$($(".lmore")[1]).remove():$(".lmore").remove();lmore=!1;$(".lmore").on("click",function(){lmore=!0;var n=$(".contact.active").data("id");$.post("/Home/GetContactMessage",{minId:minId,contactId:n},function(n){$(".loading").hide();n==null||n.length==0?SetEmptyMessage():(SetResultOfMessage(n),$(".contact.active .text-bg-success").html("0"))})});return}f+="<li id='lastchat'><\/li><\/ul>";i=i?i:$(".contact.active .name").html();var h=i.length>30?i.substring(0,29)+"...":i,c=$(".contact.active .role").text(),l=$(".contact.active img").attr("src"),a=`
		<div class="row">
			<div class="chat px-3">
        ...
        `+f+`
            ...
            video#localVideo {
	            ...
	            height: 100vh;
                z-index:0;
            }`):$("#videoRemoteStyle").html("")});$(".contact .fa-trash").on("click",function(){faTrashClicked=!0;var n=$(this).parent().parent().parent(),t=n.data("id");confirm("Are you share to delete this chat?")&&$.post("/Home/DeleteChat",{},function(){n.remove()})});$(".del-chat").on("click",function(){$(".contacts .fa-trash").each(function(n,t){$(t).parent().hasClass("d-none")?$(t).parent().removeClass("d-none"):$(t).parent().addClass("d-none")})});$(".fa-search").on("click",function(){$("#SearchModal").modal("show")});$("#search-data").on("keydown",function(n){n.keyCode==13&&searchContent()});$("#SearchModal .fa-arrow-left").on("click",function(){$("#SearchModal").modal("hide")});$("#calllog-tab").on("click",function(){$(".calls").html("");$.post("/home/getcall",null,function(n){for(var i="",t=0;t<n.length;t++)i+=`<div class="new-ch content col-12 m-2">
                            <div class="row">
                                <div class="col-12 mx-3">
                                    <div class="float-start mx-3 ">`+(n[t].profilePic?'<img src="/profilepics/thumbnails/'+n[t].profilePic+'" class="img-pro" />':'<img src="/user-profile.png" class="img-pro" />')+`</div>
                                    <div class="float-start text-start d-contents px-2">
                                        <div class="pro">
                                            <label class="name">`+n[t].contactName+`</label>
                                            <label class="role">`+(n[t].isVideo?"video call":"voice call")+`</label>
                                            <label class="role">`+getNiceDateTimeFormat(n[t].createdDate)+"  Duration:"+getDuraton(n[t].duration)+`</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
