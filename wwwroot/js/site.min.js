function showStatus(){$("#status-options").css("opacity","1");$("#status-options").css("visibility","visible")}function searchData(){var n=$("#search input").val();n?($(".new-search-mess").hide(),$(".new-search-mess").removeClass("new-search-mess").addClass("search-mess"),$(".new-search-mess").html(""),$.post("/Home/GetAccounts",{searchKey:n},function(n){var t,r,i;if($(".def-mess").hide(),n.length==0){i=`<li class="contact new-search-mess">
        ...
        `+i+`
              ...
              <div class="progress">
                <div class="progress-bar" id="my-progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
                      ...
                      </div><label`+checkRtlOfText(n[r].body.split(",;,")[1])+`>`+textToWrite(n[r].body.split(",;,")[1])+`</label></div>`:`<label`+checkRtlOfText(n[r].body)+`>`+textToWrite(n[r].body)+`</label>`)+`<span class="`+IsSeen(n[r])+`">✓</span></li>
                <li class="`+(n[r].isReciver?"from-me":"from-other")+`" >
                    <div class="date">`+getNiceDateTimeFormat(n[r].createdDate)+`</div>
                      ...
                      <div class="card-header " `+ForwardSenderId(s)+`>`+s.split(",@,")[0]+`</div>`),f+=IsImage(u)?`<label><a href="#" data-url="/uploads/`+u+`" class="img-tag"><div><img  class="fupload" src="/uploads/thumbnails/`+u+`" /></div><div>`+u+`</div></a></label>`:IsAudio(u)?`<label><div><audio controls src="/uploads/`+u+`" ></audio></div><div> `+u+`</div></label>`:IsVideo(u)?`<label><div><video controls  ><source src="/uploads/`+u+`" ></video></div><div> `+u+`</div></label>`:IsPdfOrDoc(u)?`<label><a href="/uploads/`+u+`" target="_blank" ><div><img class="docpdfimg" src="/uploads/thumbnails/`+u.substring(0,u.lastIndexOf("."))+`.jpg" /></div><div>`+u+`</div></a></label>`:`<label><a href="/uploads/`+u+`" target="_blank" ><div><img src="/img/file-icon.png" class="img-ico" /></div><div>`+u+`</div></a></label>`,s&&(f+=`</div>`),f+=`<span class="`+IsSeen(n[r])+`">✓</span></li>`,f+=`<li class="`+(n[r].isReciver?"from-me":"from-other")+`" >`+"<div class='date'>"+getNiceDateTimeFormat(n[r].createdDate)+"<\/div>"+`</li>`;if(lmore){$(".lmore").before(f);$(".lmore").length>1?$($(".lmore")[1]).remove():$(".lmore").remove();lmore=!1;$(".lmore").on("click",function(){lmore=!0;var n=$(".contact.active").data("id");$.post("/Home/GetContactMessage",{minId:minId,contactId:n},function(n){$(".loading").hide();n==null||n.length==0?SetEmptyMessage():(SetResultOfMessage(n),$(".contact.active .text-bg-success").html("0"))})});return}f+="<li id='lastchat'><\/li><\/ul>";i=i?i:$(".contact.active .name").html();var h=i.length>30?i.substring(0,29)+"...":i,c=$(".contact.active .role").text(),l=$(".contact.active img").attr("src"),a=`
		<div class="row">
			<div class="chat px-3">
        ...
        `+f+`
            ...
            video#localVideo {
	            ...
	            height: 100vh;
                z-index:0;
            }`):$("#videoRemoteStyle").html("")});$(".contact .fa-trash").on("click",function(){faTrashClicked=!0;var n=$(this).parent().parent().parent(),t=n.data("id");confirm("Are you share to delete this chat?")&&$.post("/Home/DeleteChat",{},function(){n.remove()})});