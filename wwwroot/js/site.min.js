        ...
        `+i+`
                ...
                <li class="`+(n[r].isReciver?"from-me":"from-other")+`" >
                    <div class="date">`+getNiceDateTimeFormat(n[r].createdDate)+`</div>
                      ...
                      <div class="card-header">`+s+`</div>`),f+=IsImage(u)?`<label><a href="#" data-url="/uploads/`+u+`" class="img-tag"><div><img  class="fupload" src="/uploads/thumbnails/`+u+`" /></div><div>`+u+`</div></a></label>`:IsAudio(u)?`<label><div><audio controls src="/uploads/`+u+`" ></audio></div><div> `+u+`</div></label>`:IsVideo(u)?`<label><div><video controls  ><source src="/uploads/`+u+`" ></video></div><div> `+u+`</div></label>`:IsPdfOrDoc(u)?`<label><a href="/uploads/`+u+`" target="_blank" ><div><img src="/uploads/thumbnails/`+u.substring(0,u.lastIndexOf("."))+`.jpg" /></div><div>`+u+`</div></a></label>`:`<label><a href="/uploads/`+u+`" target="_blank" ><div><img src="/img/file-icon.png" class="img-ico" /></div><div>`+u+`</div></a></label>`,s&&(f+=`</div>`),f+=`</li>`,f+=`<li class="`+(n[r].isReciver?"from-me":"from-other")+`" >`+"<div class='date'>"+getNiceDateTimeFormat(n[r].createdDate)+"<\/div>"+`</li>`;if(lmore){$(".lmore").before(f);$(".lmore").length>1?$($(".lmore")[1]).remove():$(".lmore").remove();lmore=!1;$(".lmore").on("click",function(){lmore=!0;var n=$(".contact.active").data("id");$.post("/Home/GetContactMessage",{minId:minId,contactId:n},function(n){$(".loading").hide();n==null||n.length==0?SetEmptyMessage():(SetResultOfMessage(n),$(".contact.active .text-bg-success").html("0"))})});return}f+="<li id='lastchat'><\/li><\/ul>";i=i?i:$(".contact.active .name").html();var h=i.length>30?i.substring(0,29)+"...":i,c=$(".contact.active .role").text(),l=$(".contact.active img").attr("src"),a=`
		<div class="row">
			<div class="chat px-3">
