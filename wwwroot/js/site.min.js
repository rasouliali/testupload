var lastUserIngroup="",thisContactEmj=($(".btn-savedmessage").on("click",function(){$(".loading").show(),$(".contact").removeClass("active"),$(".mycontact").attr("data-id",myUserId),$(".mycontact").addClass("active"),$.post("/Home/GetContactMessage",{minId:"0",contactId:myUserId},function(e){lastUserIngroup="",$(".loading").hide(),null==e||0==e.length?SetEmptyMessage():(SetResultOfMessage(e),$(".contact.active .text-bg-success").html(""))})}),[]),faTrashClicked=!1,SelectLi=!1,minId="0",lmore=!1;try{JSBridge.setUserId(myUserId)}catch{}var dt1,visible=!0;function showStatus(){$("#status-options").css("opacity","1"),$("#status-options").css("visibility","visible")}function searchContact(){var e=$("#search input").val();e?($(".new-search-mess").hide(),$(".new-search-mess").removeClass("new-search-mess").addClass("search-mess"),$(".new-search-mess").html(""),$.post("/Home/GetAccounts",{searchKey:e},function(e){if($(".def-mess").hide(),0==e.length)i=`<li class="contact new-search-mess">
            ...
            <ul><li id='lastchat'></li></ul>`+`
                ...
                <a href="#" class="back-to-top z-3 d-flex align-items-center justify-content-center"><i class="fa fa-arrow-down"></i></a>
					<div id="drop-area" class="chat-pm-input ">
                        ...
                        <div class="attach-menu d-none">
                            <div class="input-group-append attach">
                                <div class="input-group-text "><img src="/img/at/file.png" /></div>
                                <div>Attach file</div>
                            </div>
                            <div class="input-group-append location">
                                <div class="input-group-text "><img src="/img/at/location.png" /></div>
                                <div>Location</div>
                            </div>
                            `+($(".contact.active").hasClass("grp")?`<div class="input-group-append survey_btn" id="survey_btn">
                                <div class="input-group-text "><img src="/img/at/poll.png" /></div>
                                <div>Survey</div>
                            </div>`:"")+`
                            <div class="input-group-append minus">
                                <div class="input-group-text "><img src="/img/minus.png" /></div>
                                <div>Hide this</div>
                            </div>
                        </div>
              ...
              <div class="progress">
                ...
                </li>`,0<d&&removeLiAfterSecond(e[n].id,1e3*(d+1));else{var m=[],p=(m.push(e[n].body),"");0<=e[n].body.indexOf("^")&&(m=e[n].body.split("^"),p="");for(var v=0;v<m.length;v++){var u=m[v];0<m[v].indexOf(",;,")&&(u=m[v].split(",;,")[1],p=m[v].split(",;,")[0],m[v]=m[v].replace(",;,"," ")),s=(s+='<li class="'+(e[n].isReciver?"from-me":"from-other")+'" data-id="'+e[n].id+'" >')+(e[n].grpContactName&&lastUserIngroup!=e[n].grpContactName?"<div class='"+(e[n].isReciver?"float-end":"float-start")+"'><img src='"+c+"' class='img-pro' /></div><div class='"+(e[n].isReciver?"float-end":"float-start")+" name'>"+e[n].grpContactName+"</div>":""),p&&(s+='<div class="card" data-id="'+(replyid||"")+`" >
                      <div class="card-header " `+ForwardSenderId(p)+">"+p.split(",@,")[0]+"</div>"),IsImage(removeCaptionFromFilename(u))?s+='<label ><a href="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up" class="js-smartPhoto img-tag"><div><img  class="fupload" src="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up&th=true" /></div><div>'+SimpleFileName(u)+"</div></a></label>":IsAudio(removeCaptionFromFilename(u))?s+='<label><div><audio controls src="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up" ></audio></div><div> '+SimpleFileName(u)+"</div></label>":IsVideo(u)?s+='<label><div><video controls  ><source src="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up" ></video></div><div> '+SimpleFileName(u)+"</div></label>":IsPdfOrDoc(removeCaptionFromFilename(u))?s+='<label><a href="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up" target="_blank" ><div><img class="docpdfimg" src="/Home/GetFile?fileName='+removeCaptionFromFilename(u).substring(0,removeCaptionFromFilename(u).lastIndexOf("."))+'.jpg&fileType=up&th=true" /></div><div>'+SimpleFileName(u)+"</div></a></label>":s+='<label><a href="/Home/GetFile?fileName='+removeCaptionFromFilename(u)+'&fileType=up" target="_blank" ><div><img src="/img/file-icon.png"  /></div><div>'+SimpleFileName(u)+"</div></a></label>",p&&(s+="</div>"),s=(s+=(e[n].isReciver?'<span class="'+IsSeen(e[n])+'">✓</span>':"")+"</li>")+('<li class="'+(e[n].isReciver?"from-me":"from-other")+"\" ><div class='date'>"+getNiceDateTimeFormat(e[n].createdDate)+"</div></li>")}}e[n].grpContactName&&(lastUserIngroup=e[n].grpContactName)}lmore?($(".lmore").before(s),(1<$(".lmore").length?$($(".lmore")[1]):$(".lmore")).remove(),lmore=!1,$(".lmore").on("click",function(){lmore=!0;var e=$(".contact.active").data("id");$.post("/Home/GetContactMessage",{minId:minId,contactId:e},function(e){$(".loading").hide(),null!=e&&0<e.length&&(SetResultOfMessage(e),$(".contact.active .text-bg-success").html(""))})})):(s+="<li id='lastchat'></li></ul>",l=o="",l=($(".contact.active").hasClass("grp")?(o=30<(a=a||$(".contact.active .group-name").html()).length?a.substring(0,29)+"...":a,$(".contact.active .chat-bio")):(o=30<(a=a||$(".contact.active .name").html()).length?a.substring(0,29)+"...":a,$(".contact.active .company").text(),$(".contact.active .role"))).text(),a=`
		<div class="row">
			<div class="chat px-3">
        ...
        .video:has(#`+t+`){display:block !important;}
            ...
            </script>`,$("#group-contents").html(t),$("#CreateGroupModal").modal("show"),$("#save-group").on("click",function(){var e=!1;$("#Title").val()||($('[asp-validation-for="Title"]').html("Title is required."),e=!0),$("#GroupBIO").val()||($('[asp-validation-for="GroupBIO"]').html("GroupBIO is required."),e=!0),$("#GroupUserIds").val()||($('[asp-validation-for="GroupUserIds"]').html("GroupUserIds is required."),e=!0),e||$.post("/Home/CreateGroup",{Title:$("#Title").val(),GroupBIO:$("#GroupBIO").val(),GroupUserIds:$("#GroupUserIds").val()},function(e){$(".loading").show(),window.location.reload()})})})}),$(".pinunpin").on("click",function(){selectDefMessForPin=!0,setTimeout(function(){selectDefMessForPin=!1},200),$(this).toggleClass("active");var e=$(this).hasClass("active"),t=$(this).parent().parent().parent().attr("data-id");$.post("/Home/PinChat",{Pinned:e,chatid:t},function(e){if(e&&e.res&&0<e.res.length){$(".mess.def-mess .pinunpin").removeClass("active");for(var t=0;t<e.res.length;t++)$(".mess.def-mess").eq(t+1).attr("data-id")!=e.res[t]&&$(".mess.def-mess").eq(t+1).before($('.mess.def-mess[data-id="'+e.res[t]+'"]')),$('.mess.def-mess[data-id="'+e.res[t]+'"] .pinunpin').addClass("active")}})}),$.post("/Home/GetDefPinChat",{},function(e){if(e&&e.res&&0<e.res.length)for(var t=0;t<e.res.length;t++)$(".mess.def-mess").eq(t+1).attr("data-id")!=e.res[t]&&$(".mess.def-mess").eq(t+1).before($('.mess.def-mess[data-id="'+e.res[t]+'"]')),$('.mess.def-mess[data-id="'+e.res[t]+'"] .pinunpin').addClass("active")});