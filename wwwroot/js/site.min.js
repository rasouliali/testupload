                        ...
                        <div class="wrap">
                            ...
                            <div class="row">
                                <div class="col-12 mx-3 b-online">
                                    ...
                                    <div class="float-start text-start d-contents px-2">
                                        <div class="pro">`+(i.isGroup?`
                                            <label class="group-name">`+(i.name||i.username)+(i.id==myUserId?"<span class='badge text-info'>(You)</span>":"")+`</label>
                                            <label class="chat-bio">`+i.companyName+"</label>":`
