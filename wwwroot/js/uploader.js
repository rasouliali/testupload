        ...
        complete: function () {
            ...
            for (var i = 0; i < resArr.length; i++) {
                ...
                if (IsImage(resArr[i]))
                    ...
                    strLi += `<label><a href="/uploads/` + resArr[i] + `" target="_blank" ><div><img src="/uploads/thumbnails/` + resArr[i].substring(0, resArr[i].lastIndexOf('.')) + `.jpg"  /></div><div>` + resArr[i] + `</div></a></label>`;
                else
