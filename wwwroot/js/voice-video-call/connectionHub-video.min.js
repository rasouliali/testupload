function timerDisplayFun(){var r=new Date,n=r-dt1,t=Math.floor(n/1e3%60),i=Math.floor(n/6e4);document.querySelector(".recording-timer-display label").innerHTML=(i<10?"0":"")+i.toString()+":"+(t<10?"0":"")+t.toString();videoaudiotimer=setTimeout(timerDisplayFun,1e3)}function ProcessReceiveMessege(n,t,i){var e,o,h,y,v,a,f,l,s,u,c,r;if(notifring.play(),e=n.split(";;;")[1],n.startsWith("delmess;,;")){t?$(".contact[data-id="+t+"]").hasClass("active")&&(o=n.replace("delmess;,;","").split(";;;")[0],$("ul li[data-id="+o+"]").remove()):$(".contact[data-id="+e+"]").hasClass("active")&&(o=n.replace("delmess;,;","").split(";;;")[0],$("ul li[data-id="+o+"]").remove());return}if(n.startsWith("customNotif:")){try{var v=n.split(";;;")[3],p=n.split(";;;")[2],w=n.split(";;;")[4];JSBridge.setCustomNotification(p,w,parseInt(v))}catch{}return}if(t)h=$(".contact[data-id="+t+"] .text-bg-success").html(),h==undefined&&appendNewContactById(t,!0);else if(h=$(".contact[data-id="+e+"] .text-bg-success").html(),h==undefined){appendNewContactById(e);return}h?(y=parseInt(h.replace(" ","").replace("(","").replace(")","")),y++,$(".contact[data-id="+(t?t:e)+"] .text-bg-success").html(y)):$(".contact[data-id="+(t?t:e)+"] .text-bg-success").html("1");try{v=n.split(";;;")[3];JSBridge.setNotification("you have new message",v)}catch{}if($(".contact[data-id="+(t?t:e)+"]").hasClass("active")){if(a=n.split(";;;")[0],f=n.split(";;;")[2],o=n.split(";;;")[3],l=n.split(";;;")[4],s="",a=="isfile")for(u=f.split(",;,")[0].split(";"),c="",f.split(",;,").length>1&&(c=f.split(",;,")[1]),r=0;r<u.length;r++)s+=`<li class="from-other" data-id="`+o+`" >`,s+=t?"<div class='name'>"+i+"<\/div>":"",c&&(s+=`<div class="newcard" data-id="`+(l?l:"")+`" >
