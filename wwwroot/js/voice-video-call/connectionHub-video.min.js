function timerDisplayFun(){var r=new Date,n=r-dt1,t=Math.floor(n/1e3%60),i=Math.floor(n/6e4);document.querySelector(".recording-timer-display label").innerHTML=(i<10?"0":"")+i.toString()+":"+(t<10?"0":"")+t.toString();videoaudiotimer=setTimeout(timerDisplayFun,1e3)}function ProcessReceiveMessege(n,t,i){var e,o,h,y,v,a,f,l,s,u,c,r;if(notifring.play(),e=n.split(";;;")[1],n.startsWith("delmess;,;")){t?$(".contact[data-id="+t.toLowerCase()+"]").hasClass("active")&&(o=n.replace("delmess;,;","").split(";;;")[0],$("ul li[data-id="+o+"]").remove()):$(".contact[data-id="+e+"]").hasClass("active")&&(o=n.replace("delmess;,;","").split(";;;")[0],$("ul li[data-id="+o+"]").remove());return}if(n.startsWith("customNotif:")){try{var v=n.split(";;;")[3],p=n.split(";;;")[2],w=n.split(";;;")[4];JSBridge.setCustomNotification(p,w,parseInt(v))}catch{}return}if(t)h=$(".contact[data-id="+t.toLowerCase()+"] .text-bg-success").html(),h==undefined&&appendNewContactById(t,!0);else if(h=$(".contact[data-id="+e.toLowerCase()+"] .text-bg-success").html(),h==undefined){appendNewContactById(e);return}h?(y=parseInt(h.replace(" ","").replace("(","").replace(")","")),y++,$(".contact[data-id="+(t?t:e).toLowerCase()+"] .text-bg-success").html(y)):$(".contact[data-id="+(t?t:e).toLowerCase()+"] .text-bg-success").html("1");try{v=n.split(";;;")[3];JSBridge.setNotification("you have new message",v)}catch{}if($(".contact[data-id="+(t?t:e).toLowerCase()+"]").hasClass("active")){if(a=n.split(";;;")[0],f=n.split(";;;")[2],o=n.split(";;;")[3],l=n.split(";;;")[4],s="",a=="isfile")for(u=f.split(",;,")[0].split(";"),c="",f.split(",;,").length>1&&(c=f.split(",;,")[1]),r=0;r<u.length;r++)s+=`<li class="from-other" data-id="`+o+`" >`,s+=t?"<div class='name'>"+i+"<\/div>":"",c&&(s+=`<div class="newcard" data-id="`+(l?l:"")+`" >
                      <div class="card-header" `+ForwardSenderId(c)+`>`+c.split(",@,")[0]+`</div>`),s+=IsImage(u[r])?`<label><a data-url="/Home/GetFile?fileName=`+u[r]+`&fileType=up" class="img-tag"><div><img  class="fupload" src="/Home/GetFile?fileName=`+u[r]+`&fileType=up&th=true" /></div><div>`+u[r]+`</div></a></label>`:IsAudio(u[r])?`<label><div><audio controls src="/Home/GetFile?fileName=`+u[r]+`&fileType=up" ></audio></div><div> `+u[r]+`</div></label>`:IsVideo(u[r])?`<label><div><video controls  ><source src="/Home/GetFile?fileName=`+u[r]+`&fileType=up" ></video></div><div> `+u[r]+`</div></label>`:IsPdfOrDoc(u[r])?`<label><a href="/Home/GetFile?fileName=`+u[r]+`&fileType=up" target="_blank" ><div><img class="docpdfimg" src="/Home/GetFile?fileName=`+u[r].substring(0,u[r].lastIndexOf("."))+`.jpg&fileType=up&th=true" /></div><div>`+u[r]+`</div></a></label>`:`<label><a href="/Home/GetFile?fileName=`+u[r]+`&fileType=up" target="_blank" ><div><img src="/img/file-icon.png" /></div><div>`+u[r]+`</div></a></label>`,c&&(s+=`</div>`),s+=`</li><li  class="from-other"><div class="date">`+getNiceDateTimeFormat(a)+`</div></li>`;else s+=`<li class="from-other"  data-id="`+o+`" >`+(t?"<div class='name'>"+i+"<\/div>":"")+(f.indexOf(",;,")>=0?`<div class="newcard" data-id="`+(l?l:"")+`" >
                      <div class="card-header">`+f.split(",;,")[0]+`</div><label `+checkRtlOfText(f.split(",;,")[1])+`>`+textToWrite(f.split(",;,")[1])+`</label></div>`:`<label`+checkRtlOfText(f)+`>`+textToWrite(f)+`</label>`)+`</li><li  class="from-other"><div class="date">`+getNiceDateTimeFormat(a)+`</div></li>`;t?wsconn.invoke("SeenMessegeForGroup",o,e,t):wsconn.invoke("SeenMessege",o,e);$("#lastchat").before(s);$("li .newcard:not(.card) .card-header").on("click",function(){var n=$(this).parent().data("id");$(".chat-pm ul").scrollTop($('[data-id="'+n+'"]').get(0).offsetTop-90);$('[data-id="'+n+'"]').eq(0).css("background","black");setTimeout(function(){$('[data-id="'+n+'"]').eq(0).css("background","transparent")},500);setTimeout(function(){$('[data-id="'+n+'"]').eq(0).css("background","black")},1e3);setTimeout(function(){$('[data-id="'+n+'"]').eq(0).css("background","transparent")},1500)});$("li .newcard:not(.card)").addClass("card");setTimeout(function(){$(".chat-pm ul").scrollTop($(".chat-pm ul").get(0).scrollHeight)},500);loadForSelectLi();$(".img-tag").unbind("click");$(".img-tag").on("click",function(){var n=$(this).data("url");loadImageModal(n)})}}function appendNewContactById(n){$.post("/Home/GetAccounts",{searchKey:n},function(n){var t;if(n.length!=0)for($(".no-mess-contact").hide(),t=0;t<n.length;t++){var i=n[t].contactName?n[t].contactName:n[t].userName,r=n[t].profilePic?"/ProfilePics/thumbnails/"+n[t].profilePic:n[t].isGroup?"/img/group-icon.png":"/img/person-icon.png",u=`<div class="mess row contact new-def-mess def-mess" minid="`+n[t].minid+`" data-id="`+n[t].userId+`">
