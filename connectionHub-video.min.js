function appendNewContactById(n){$.post("/Home/GetAccounts",{searchKey:n},function(n){var t,i,r;if(n.length!=0)for(t=0;t<n.length;t++){i="online";i=n[t].status==1?"away":n[t].status==2?"busy":n[t].status==3?"offline":i;r=`<li class="contact new-def-mess"  data-id="`+n[t].userId+`">
                        <div class="wrap">
